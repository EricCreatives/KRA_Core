...
export class GenesisBlockBuilder {
    public network: any;
    public prefixHash: any;
    public totalPremine: any;
    public activeDelegates: any;
     ...
     * @return {Object}
     */
    public __createDelegateWallet(username) {
        const wallet: any = this.__createWallet();
     ...
     * @return {Object[]}
     */
    public __buildDelegateTransactions(wallets) {
     ...
     * @return {Object}
     */
    public __formatGenesisTransaction(transaction, wallet) {
     ...
     * @return {Object}
     */
    public __createGenesisBlock(data) {
